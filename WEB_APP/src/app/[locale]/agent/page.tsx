...
import { useStatusTranslation, usePaymentStatusTranslation } from '@/lib/i18n-helpers';
...
export default function AgentDashboardPage() {
  ...
  const translatePaymentStatus = usePaymentStatusTranslation();
                      ...
                      {enrollments.map((enrollment) => (
                        <tr key={enrollment.enrollmentId} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            >
                              {translatePaymentStatus(enrollment.payment.paid ? 'paid' : 'unpaid')}
                            </Badge>
                          </td>
                        </tr>
                      ))}
