...
import { EnrollmentTable } from '@/app/admin/components/EnrollmentTable';
  ...
  const fetchEnrollments = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        console.error('获取课程失败:', data.error);
      }
    } catch (error) {
    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">
          👋 欢迎，{teacherInfo?.teacherName || session.user.name}老师
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">课程注册</p>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                <li>点击"📝 编辑成绩"按钮可以为学生添加期中和期末成绩</li>
                <li>只有状态为"已开课"的课程才能编辑成绩</li>
                <li>成绩范围为0-100分，支持小数</li>
                <li>您可以为每个学生添加评语和建议</li>
              </ul>
            </div>
          </div>
        </CardContent>
